...
export default function EditOfferPage() {
    ...
    const handleSubmit = () => {
        ...
        updateOffer(parseInt(id), updatedOffer);
        router.push('/admin/offers');
    };

    return (
        <div style={{ paddingBottom: '50px' }}>
            <h1 style={{ fontSize: '42px', color: '#DF7E5D', fontFamily: '"Cookie", cursive', marginBottom: '30px' }}>Edit Offer</h1>
            ...
            <div style={{
                ...
                <div style={{ flex: 1, minWidth: '300px' }}>
                    ...
                    <button
                        ...
                        style={{ width: '100%', marginTop: '10px', background: 'transparent', border: '1px solid #ddd', color: '#666', padding: '12px', borderRadius: '50px', cursor: 'pointer' }}
                    >
                        Cancel
                    </button>
                </div>
